...
//Intro container in Home View
export default function HomeIntro(props) {
  const [image, setImage] = useState([
    "https://www.thetruthaboutcars.com/wp-content/uploads/2014/04/used_cars-610x405.jpg",
      ...
      <div ref={props.reference} className={styles.textbox}>
        <div>
          ...
          <p className={styles.text}>
            With over 40 years in the market, we offer from the best brands
            available from both national and imported manufacturers.
          </p>
          <p className={styles.text}> You can check all our products here:</p>
          <p className={styles.text}>
            <Link to="/home/products" className={styles.link}>
              Products List
            </Link>
          </p>
          <p className={styles.text}>
            We offer the best aftersales services with extended warranty periods
            that are totally unbelievable, and would be impossible for any other
            dealer to have.
          </p>
          <p className={styles.text}>
            All our partners work with the best sales employees to provide the
            customer a pleasant experience and make you feel like in home.
