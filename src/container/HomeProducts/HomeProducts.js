...
export default function HomeProducts(props) {
    const [image, setImage] = useState(["https://img.autocosmos.com/noticias/fotos/preview/NAZ_ca4bb7034aaa4aa29f2366b3757e1aac.jpg",
        ...
        <div className={styles.main}>
            <div ref={props.reference} className={styles.textbox}>
                <div>
                    ...
                    <p className={styles.text}>All our models are selected among the top performers of our providers.</p>
                    <p className={styles.text}>Our cars had passed the highest security test's available, to provide you with
                                                the safest options in the market</p>
                    <p className={styles.text}><Link to="/products" className={styles.link}>You can find our products here</Link></p>
                    <p className={styles.text}>We have an international web of aftersales providers with every part available on demand, 
                                                because we know that your time is valuable, to provide the fastest services in the region.</p>
                    <p className={styles.text}>Our technicians are among the best in the nation, making us the top car dealer in every aspect.</p>
                </div>
            </div>
